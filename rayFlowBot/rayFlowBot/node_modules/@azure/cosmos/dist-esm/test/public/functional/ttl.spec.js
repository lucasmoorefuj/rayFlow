...
describe("Container TTL", function () {
    ...
    async function createcontainerWithInvalidDefaultTtl(db, containerDefinition, collId, defaultTtl) {
    ...
    async function createItemWithInvalidTtl(container, itemDefinition, itemId, ttl) {
    ...
    async function checkItemGone(container, createdItem) {
    ...
    async function positiveDefaultTtlStep3(container, createdItem, itemDefinition) {
    ...
    async function positiveDefaultTtlStep2(container, createdItem, itemDefinition) {
    ...
    async function positiveDefaultTtlStep1(container, createdItem, itemDefinition) {
    ...
    async function minusOneDefaultTtlStep1(container, createdItem1, createdItem2, createdItem3) {
