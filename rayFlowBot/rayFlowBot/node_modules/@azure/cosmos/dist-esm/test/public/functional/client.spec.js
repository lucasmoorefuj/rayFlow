...
describe("Client Tests", function () {
    ...
    describe("Constructor", function () {
        ...
        it("fails to read databases with bad AAD authentication", async function () {
            try {
                const credentials = new UsernamePasswordCredential("fake-tenant-id", "fake-client-id", "fakeUsername", "fakePassword");
                const client = new CosmosClient({
                    endpoint,
    ...
    describe("Background refresher", async function () {
        ...
        it("should fetch new endpoints", function (done) {
            ...
            const client = new CosmosClient({
                endpoint,
                key: masterKey,
                connectionPolicy: Object.assign(Object.assign({}, defaultConnectionPolicy), { endpointRefreshRateInMs: 700, enableBackgroundEndpointRefreshing: true })
            });
