...
import { ClientSideMetrics, QueryMetrics, QueryPreparationTimes, RuntimeExecutionTimes, TimeSpan } from "../../../src";
describe("QueryMetrics", function () {
    ...
    it("Should Add Two Query Metrics", function () {
        ...
        const doubleSystemFunctionExecutionTime = TimeSpan.fromMilliseconds(systemFunctionExecutionTime.totalMilliseconds() * 2);
        const doubleUserDefinedFunctionExecutionTime = TimeSpan.fromMilliseconds(userDefinedFunctionExecutionTime.totalMilliseconds() * 2);
    ...
    it("Can Be Create From Delimited String", function () {
        const queryMetricsFromDelimitedString = QueryMetrics.createFromDelimitedString(delimitedString, new ClientSideMetrics(requestCharge));
    ...
    it("Can Be Converted To A Delimited String", function () {
        ...
        const queryMetricsFromDelimitedString = QueryMetrics.createFromDelimitedString(delimitedStringFromMetrics, new ClientSideMetrics(requestCharge));
