...
describe("Change Feed Iterator", function () {
    ...
    describe("Newly updated items should be fetched incrementally", function () {
        ...
        before(async function () {
            ...
            container = await getTestContainer("Newly updated items should be fetched incrementally", undefined, containerDef, throughput);
        ...
        it("should throw if used with no partition key or partition key range id", async function () {
            ...
            try {
                ...
                assert.equal(err.message, "Container is partitioned, but no partition key or partition key range id was specified.");
                return;
            }
...
//# sourceMappingURL=changeFeed.spec.js.map