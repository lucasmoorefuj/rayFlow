...
import { CosmosClient, PatchOperationType } from "../../../src";
import { bulkDeleteItems, bulkInsertItems, bulkQueryItemsWithPartitionKey, bulkReadItems, bulkReplaceItems, createOrUpsertItem, getTestDatabase, removeAllDatabases, replaceOrUpsertItem, addEntropy, getTestContainer } from "../common/TestHelpers";
...
describe("Item CRUD", function () {
    ...
    const documentCRUDTest = async function (isUpsertTest) {
        // create database
        ...
        // read document
        const response2 = await container.item(replacedDocument.id, undefined).read();
    ...
    it("Should do document CRUD operations over multiple partitions", async function () {
        ...
        const { resources: results } = await container.items
            .query(querySpec, { enableScanInQuery: true })
            .fetchAll();
