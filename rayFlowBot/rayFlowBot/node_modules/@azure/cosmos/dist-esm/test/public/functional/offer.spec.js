...
describe("NodeJS CRUD Tests", function () {
    ...
    describe("Validate Offer CRUD", function () {
        it("nativeApi Should do offer read and query operations successfully name based single partition collection", async function () {
            ...
            const collectionSize = Number(headers[Constants.HttpHeaders.MaxResourceQuota]
                .split(";")
                .reduce((map, obj) => {
            ...
            assert.equal(expectedOffer.content.offerThroughput, offerThroughput, "Expected offerThroughput to be " + offerThroughput);
