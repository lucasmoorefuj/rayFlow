...
describe("NodeJS CRUD Tests", function () {
    ...
    describe("Validate Permission CRUD", function () {
        const permissionCRUDTest = async function (isUpsertTest) {
            ...
            // create permission
            const { resource: createdPermission } = await createOrUpsertPermission(user, permissionDef, undefined, isUpsertTest);
            ...
            const { resource: replacedPermission } = await replaceOrUpsertPermission(user, permissionDef, undefined, isUpsertTest);
        ...
        const permissionCRUDOverMultiplePartitionsTest = async function (isUpsertTest) {
            // create database
            // create container
            ...
            const container = await getTestContainer("permission CRUD over multiple partitions", undefined, containerDefinition);
            // create user
            const { resource: userDef } = await container.database.users.create({ id: "new user" });
            const user = container.database.user(userDef.id);
            // list permissions
