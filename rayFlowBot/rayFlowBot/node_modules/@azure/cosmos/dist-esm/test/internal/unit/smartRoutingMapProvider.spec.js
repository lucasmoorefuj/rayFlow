...
describe("Smart Routing Map Provider OverlappingRanges", function () {
    ...
    const mockedClientContext = new MockedClientContext(partitionKeyRanges);
    ...
    const assertBothProvidersResultsEqual = async (queryRanges) => {
        let results1;
        let results2;
        let err1;
        let err2;
    ...
    const validateProviderOverlappingRanges = async function (provider, queryRanges, expectedResults, errorExpected) {
    ...
    const validateSmartOverlappingRanges = async function (queryRanges, expectedResults, errorExpected) {
    ...
    const validatePartitionKeyRangeCacheOverlappingRanges = async function (queryRanges, expectedResults, errorExpected) {
        await validateProviderOverlappingRanges(partitionKeyRangeCache, queryRanges, expectedResults, errorExpected);
    };
    // Validates the results
    // smartRoutingMapProvider.getOverlappingRanges()
    // partitionKeyRangeCache.getOverlappingRanges() is as expected
    const validateOverlappingRanges = async function (queryRanges, expectedResults, errorExpected) {
        errorExpected = errorExpected || false;
    ...
    const assertProviderOverlappingRangesAreEqual = async function (provider, queryRanges1, queryRanges2) {
        let results1;
        let results2;
        let err1;
        let err2;
    ...
    const assertOverlappingRangesAreEqual = async function (queryRanges1, queryRanges2) {
        await assertProviderOverlappingRangesAreEqual(smartRoutingMapProvider, queryRanges1, queryRanges2);
        await assertProviderOverlappingRangesAreEqual(partitionKeyRangeCache, queryRanges1, queryRanges2);
